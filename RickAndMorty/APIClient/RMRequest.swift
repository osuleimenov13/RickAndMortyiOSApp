...
final class RMRequest {
    ...
    /// Desired endpoint
    public let endpoint: RMEndpoint // making public for NSCache business in our RMService
    ...
    /// Constructed url for the api reguest in string format
