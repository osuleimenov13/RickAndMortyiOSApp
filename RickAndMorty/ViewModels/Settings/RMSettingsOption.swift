...
enum RMSettingsOption: CaseIterable { // to loop over all cases
    case rateApp
    case contactUs
    case terms
    case privacy
    ...
    var targetUrl: URL? {
        ...
        case .viewSeries:
            return URL(string: "https: //www.youtube.com/playlist?list=PL5PR3UyfTwvd14Ya_2veOB6TM16FXuv4y")
        case .viewCode:
            return URL(string: "https://github.com/AfrazCodes/RickAndMortyi0SApp")
        }
    }
