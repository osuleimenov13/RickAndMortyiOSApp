...
protocol RMEpisodeDetailsViewDelegate: AnyObject { // anyobject to be able to handle been weak reference
...
extension RMEpisodeDetailsView: UICollectionViewDelegate, UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        case .characters:
            ...
            delegate?.rmEpisodeDetailsView(self, didSelectCharacter: character)
        }
    }
}
